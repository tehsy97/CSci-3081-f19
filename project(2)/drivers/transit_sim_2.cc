...
void Report_Starting(std::ostream &out) {
...
void Report_Complete(std::ostream &out) {
  out << "/*************************" << std::endl << std::endl;
  out << "        SIMULATION" << std::endl;
...
void Report_Begin(std::ostream &out) {
    out << "/*************************" << std::endl << std::endl;
    out << "           BEGIN" << std::endl;
    out << "          UPDATING" << std::endl;
    out << "*************************/" << std::endl;
}
...
int main() {
  ...
  CC_WB_probs.push_back(.1);      // Jones-Edd  std::cout << "/*************************" << std::endl << std::endl;
  ...
  // Again, MUST be dynamic...std::vector<int>::iterator bus_gen_timing_iter = bus_start_timings_.begin();
  ...
  for (int i = 0; i < rounds; i++) {
    ...
    for (std::vector<Route *>::iterator route_iter = prototype_routes_.begin();
      ...
      (*route_iter)->GetRouteData();
    }

  }


  Report_Complete(std::cout);
