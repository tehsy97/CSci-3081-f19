...
class PassengersTests : public ::testing::Test {
 protected:
    Passenger* passenger;
...
TEST_F(PassengersTests, Constructor) {
    EXPECT_EQ(passenger->IsOnBus(), false);
    passenger->GetOnBus();
    EXPECT_EQ(passenger->IsOnBus(), true);
}

TEST_F(PassengersTests, GetDestination) {
    EXPECT_EQ(passenger1->GetDestination(), 33);
}

TEST_F(PassengersTests, GetTotalWait) {
...
TEST_F(PassengersTests, GetOnBus_and_IsOnBus) {
    EXPECT_EQ(passenger1->IsOnBus(), false);
    passenger1->GetOnBus();
    EXPECT_EQ(passenger1->IsOnBus(), true);
...
TEST_F(PassengersTests, passenger) {
...
TEST_F(PassengersTests, passenger_list) {
